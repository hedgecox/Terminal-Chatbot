const ColorLookup = { 0: "#0C0C0C", 1: "#0037DA", 2: "#13A10E", 3: "#3A96DD", 4: "#C50F1F", 5: "#881798", 6: "#C19C00", 7: "#CCCCCC", 8: "#767676", 9: "#3B78FF", a: "#16C60C", b: "#61D6D6", c: "#E74856", d: "#B4009E", e: "#F9F1A5", f: "#F2F2F2" }
...
color           Sets the default console foreground and background colors.`
            ...
            case "color":
                if (words[1] && words[1].match(/^[0-9a-f]{2}$/)) {
                    document.documentElement.style.setProperty('--terminal_bg', ColorLookup[words[1][0]]);
                    document.documentElement.style.setProperty('--terminal_fg', ColorLookup[words[1][1]]);
                    return null
                } else {
